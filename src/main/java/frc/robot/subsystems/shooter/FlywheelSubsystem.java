...
public class FlywheelSubsystem extends SubsystemBase implements Loggable {
  ...
  private PIDController mPID = new PIDController(20d/(Constants.Flywheel.kFlywheelRatio * Units.radiansPerSecondToRotationsPerMinute(DCMotor.getFalcon500(1).freeSpeedRadPerSec)), 0, 0);
  // Volts for max rpm divided by the flywheel gear ratio in rpm 
